      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Welcome to <span className="font-semibold text-emerald-600">ShopEase</span> — your one-stop destination
          ...
          <button className="bg-emerald-600 text-white px-6 py-3 rounded-full hover:bg-emerald-700 transition-all duration-300">
            Shop Now
          </button>
        </div>
      </div>
